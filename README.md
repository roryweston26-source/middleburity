...
| National Weather Service (api.weather.gov, public domain) | Forecasts and active alerts for campus and the Snow Bowl | live, cached 30 minutes |
| The Middlebury Snow Bowl's hours calendar | Lift hours by day, from the calendar on its hours page. Trail and lift conditions are only in the Snow Bowl's app, so they aren't covered | live, cached 3 hours |
| The Snow Bowl's and Rikert Outdoor Center's student pages (in the page index) | Student season passes and pricing, day tickets, lessons, Winter Term PE, rentals | in the page index |
