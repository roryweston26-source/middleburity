...
export const directionsTool = {
  definition: {
    name: "get_directions",
    description:
      "A Google Maps walking link between campus places, shown as a button. " +
      "You can't see the route: never describe turns or walking times; straight-line distance is the only number you have. " +
      "If they say 'my dorm' without naming it, ask which. Omit `from` to start from their location. " +
      "If the result has a note, pass it on.",
    input_schema: {
      type: "object",
      properties: {
